  ...
  static getSyncData(): DataModel[] {
    ...
    function addDescriptionToTrait(trait: DataPoint) {
      switch (trait.name) {
        case "11.6.2":
          trait.description =
            "Average fine particule matter concentrations (PM 2.5). Target: 50% of the built up area of cities.";
          break;
        case "11.3.1":
          trait.description =
            "Ratio of land consumption rate to population growth rate (1971 to 2011). Target: A ratio of 1.";
          break;
        case "11.7.2":
          trait.description = "Sexual assault (rate per 100,000 population). Target: 0 per 100,000 population.";
          break;
        case "11.1.1":
          trait.description = "Proportion of households in core housing need. Target: 0% of the population.";
          break;
        case "11.7.1":
          trait.description = "Average share of the built-up area of cities that is open space for public use for all, by sex, age and persons with disabilities. Target: $1,500 per capita in total expenditures.";
            break;
        case "11.5.1":
          trait.description =
            "Number of people who died, went missing or were directly affected by disasters per 100,000 population. Target: 0.";
          break;
        case "11.4.1":
          trait.description = "Total per capita expenditure on the preservation, protection and conservation of all cultural and natural heritage, by source of funding (public, private), type of heritage (cultural, natural) and level of government (national, regional, and local/municipal). Target: 0.";
          break;
        case "11.5.2":
          trait.description =
            "Direct economic loss: the monetary value of total or partial destruction of physical assets existing in the affected area. Direct economic loss is nearly equivalent to physical damage (based on the Inflation Calculator). Target: 100% of urban solid waste.";
          break;
        case "11.2.1":
          trait.description =
            "Percentage of population less than 500 metres from public transit access point. Target: 100% of the population.";
          break;
        case "11.3.2":
          trait.description = "Score of direct and regular participation by civil society in the urban planning and management of the primate city. Target: A score of 5 on the UN-Habitat survey.";
          break;
        case "11.6.1":
          trait.description =
            "Proportion of urban solid waste regularly collected and with adequate final discharge out of total urban solid waste generated by cities. Target: 10 (per recommendations from the CDC).";
          break;
      }
    }
    return countryData;
