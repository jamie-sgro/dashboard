...
raw <- list2ballot(
  x = list(
    ...
    c("Victoria","Vancouver","Halifax","Sherbrooke","St. John's","Calgary","Winnipeg","Edmonton","Saskatoon","London","St. Catharines--Niagara","Toronto","Montr�al","Kitchener--Cambridge--Waterloo","Hamilton","Regina","Quebec City","Windsor"),
